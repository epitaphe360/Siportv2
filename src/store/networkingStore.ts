...
import { NetworkingRecommendation } from '@/types';
...
interface NetworkingState {
  ...
  selectedExhibitorForRDV: any | null; // Using 'any' for flexibility with profile data
  ...
  setSelectedExhibitorForRDV: (exhibitor: any | null) => void;
