...
export default function MiniSiteEditor() {
  ...
  const updateProductField = (sectionId: string, productIndex: number, field: string, value: unknown) => {
    setSections(sections.map(section => {
                                      ...
                                      <img
                                        ...
                                        onClick={() => {
                                          ...
                                          input.onchange = (e) => {
                                            const file = (e.target as HTMLInputElement).files?.[0];
                                            if (file) {
                                              toast.success(`Image produit sélectionnée: ${file.name}`);
                                            }
                                          };
                                          input.click();
                                        }}
                                      ...
                                      <div className="mt-4 pt-3 border-t border-gray-200">
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            toast.success(`Email de notification modifié: ${e.target.value}`);
                                          }}
                                      ...
                                      <div className="mt-3">
                                        <Button 
                                          ...
                                          onClick={() => {
                                            ...
                                            toast.success(`Formulaire configuré — notifications: ${config.notifications.email}`);
                                          }}
                                        >
