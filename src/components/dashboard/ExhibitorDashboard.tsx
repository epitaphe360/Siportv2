...
export default function ExhibitorDashboard() {
  ...
  // Fonction pour ouvrir les analytics détaillés
  const openDetailedAnalytics = () => {
    setModal({
      title: 'Analytics Détaillés - SIPORTS 2026',
      content: (
        <div className="space-y-6">
          {/* Graphiques simulés */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl">
              <h4 className="font-bold text-blue-900 mb-4">📈 Évolution des Vues</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-sm">Aujourd'hui</span>
                  <span className="font-bold">+24 vues</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Cette semaine</span>
                  <span className="font-bold">+156 vues</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Ce mois</span>
                  <span className="font-bold">+2,156 vues</span>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl">
              <h4 className="font-bold text-green-900 mb-4">🎯 Taux de Conversion</h4>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-sm">Vues → Téléchargements</span>
                  <span className="font-bold">3.2%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">Téléchargements → RDV</span>
                  <span className="font-bold">8.7%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm">RDV → Conversions</span>
          ...
          <div className="bg-gray-50 p-6 rounded-xl">
            <h4 className="font-bold text-gray-900 mb-4">📊 Métriques Détaillées</h4>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Nouvelles connexions</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-xl">
            <h4 className="font-bold text-yellow-900 mb-4">💡 Recommandations</h4>
            <ul className="space-y-2 text-sm text-yellow-800">
              <li>• Optimisez votre mini-site pour améliorer le taux de conversion</li>
              <li>• Répondez rapidement aux demandes de rendez-vous</li>
              <li>• Partagez votre QR code dans vos communications</li>
              <li>• Mettez à jour régulièrement votre profil exposant</li>
            </ul>
          </div>
        </div>
      )
          ...
          content: (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Link to="/calendar">
                  <Button variant="outline" className="w-full">Ouvrir le calendrier</Button>
                </Link>
              </div>
            </div>
          )
        ...
        setModal({
          ...
          content: (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Link to="/messages">
                  <Button variant="outline" className="w-full">Voir tous les messages</Button>
                </Link>
                <Link to="/chat">
                  <Button variant="outline" className="w-full">Ouvrir le chat</Button>
                </Link>
              </div>
            </div>
          )
