            ...
            <Card>
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <Link to="/partners/profile/edit" className="block">
                  ...
                  <Link to="/partners/events" className="block">
                    <Button className="w-full justify-start" variant="outline">
                  ...
                  <Link to="/partners/networking" className="block">
                    <Button className="w-full justify-start" variant="outline">
          ...
          <Card>
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/partners/activity" className="block">
